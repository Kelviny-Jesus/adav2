...
import {
  customAlphabet
} from "./chunk-AYULTX3E.js";
import {
  ZodFirstPartyTypeKind,
  ZodOptional,
  require_secure_json_parse
} from "./chunk-DXRYS5U6.js";
import {
  require_react
...
var require_use_sync_external_store_shim_production = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.production.js"(exports) {
    ...
    var useEffect3 = React4.useEffect;
...
function safeParseJSON({
  ...
  try {
    const value = import_secure_json_parse2.default.parse(text);
    if (schema == null) {
...
async function processChatResponse({
  ...
  onToolCall,
  onFinish,
  generateId: generateId22 = generateId2,
  ...
  ((_b = (_a16 = lastMessage.toolInvocations) == null ? void 0 : _a16.reduce((max, toolInvocation) => {
    var _a23;
    return Math.max(max, (_a23 = toolInvocation.step) != null ? _a23 : 0);
  }, 0)) != null ? _b : 0) : 0;
  ...
  await processDataStream({
    ...
    onReasoningPart(value) {
      ...
      message.reasoning = ((_a23 = message.reasoning) != null ? _a23 : "") + value;
      execUpdate();
    },
...
async function callChatApi({
  ...
  const response = await fetch2(api, {
    ...
    signal: (_a16 = abortController == null ? void 0 : abortController()) == null ? void 0 : _a16.signal,
    credentials
  }).catch((err) => {
    restoreMessagesOnFailure();
    throw err;
...
function getMessageParts(message) {
  var _a16;
  return (_a16 = message.parts) != null ? _a16 : [
  ...
  if (attachmentsFromOptions instanceof FileList) {
    return Promise.all(
      Array.from(attachmentsFromOptions).map(async (attachment) => {
        const { name: name15, type } = attachment;
        const dataUrl = await new Promise((resolve, reject) => {
          const reader = new FileReader();
          reader.onload = (readerEvent) => {
            var _a16;
            resolve((_a16 = readerEvent.target) == null ? void 0 : _a16.result);
          };
...
function shouldResubmitMessages({
  ...
  return (
    ...
    ((_a16 = extractMaxToolInvocationStep(lastMessage.toolInvocations)) != null ? _a16 : 0) < maxSteps
  );
}
...
function updateToolCallResult({
  ...
  lastMessage.toolInvocations = (_a16 = lastMessage.toolInvocations) == null ? void 0 : _a16.map(
...
function useAssistant({
  ...
  const append = async (message, requestOptions) => {
    ...
    setMessages((messages2) => {
      ...
      return [
        ...
        {
          ...message,
          id: (_a23 = message.id) != null ? _a23 : generateId2()
        }
      ];
    });
    setInput("");
    ...
    try {
      ...
      const response = await actualFetch(api, {
        ...
        body: JSON.stringify({
          ...
          threadId: (_a16 = threadIdParam != null ? threadIdParam : currentThreadId) != null ? _a16 : null,
        ...
        onDataMessagePart(value) {
          setMessages((messages2) => {
            ...
            return [
              ...messages2,
              {
                id: (_a23 = value.id) != null ? _a23 : generateId2(),
                role: "data",
                content: "",
                data: value.data,
                parts: []
  ...
  const submitMessage = async (event, requestOptions) => {
    var _a16;
    (_a16 = event == null ? void 0 : event.preventDefault) == null ? void 0 : _a16.call(event);
    if (input === "") {
      return;
    }
...
function useChat({
  ...
  const [hookId] = (0, import_react5.useState)(generateId22);
  const chatId = id != null ? id : hookId;
  const chatKey = typeof api === "string" ? [api, chatId] : chatId;
  const [initialMessagesFallback] = (0, import_react5.useState)(
  ...
  const triggerRequest = (0, import_react5.useCallback)(
    async (chatRequest) => {
      ...
      const maxStep = extractMaxToolInvocationStep(
        (_a16 = chatMessages[chatMessages.length - 1]) == null ? void 0 : _a16.toolInvocations
      );
      try {
        const abortController = new AbortController();
        abortControllerRef.current = abortController;
  ...
  const append = (0, import_react5.useCallback)(
    async (message, {
      ...
      const messages2 = messagesRef.current.concat({
        ...message,
        id: (_a16 = message.id) != null ? _a16 : generateId22(),
  ...
  const handleSubmit = (0, import_react5.useCallback)(
    ...
    [input, generateId22, triggerRequest]
  );
...
function useCompletion({
  ...
  const [abortController, setAbortController] = (0, import_react6.useState)(null);
  const extraMetadataRef = (0, import_react6.useRef)({
    credentials,
    headers,
    body
  });
  ...
  const triggerRequest = (0, import_react6.useCallback)(
  ...
  const setCompletion = (0, import_react6.useCallback)(
    (completion2) => {
  ...
  const [input, setInput] = (0, import_react6.useState)(initialInput);
...
function useObject({
  ...
  const stop = (0, import_react7.useCallback)(() => {
    var _a16;
    try {
      (_a16 = abortControllerRef.current) == null ? void 0 : _a16.abort();
    } catch (ignored) {
    } finally {
      setIsLoading(false);
      abortControllerRef.current = null;
  ...
  const submit = async (input) => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(
          (_a16 = await response.text()) != null ? _a16 : "Failed to fetch the response."
        );
      }
      if (response.body == null) {
        throw new Error("The response body is empty.");
...
// node_modules/ai/react/dist/index.mjs
var useChat2 = useChat;
var useCompletion2 = useCompletion;
var useAssistant2 = useAssistant;
var experimental_useObject2 = experimental_useObject;
export {
  experimental_useObject2 as experimental_useObject,
  useAssistant2 as useAssistant,
  useChat2 as useChat,
  useCompletion2 as useCompletion
};
